      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl md:h-[90%] bg-white px-6 py-8 rounded-2xl shadow-md">
        ...
        <div className="flex flex-col justify-center items-center w-full">
          <form className="flex flex-col gap-5 w-full max-w-sm">
            ...
            <div className="mt-4">
              <button className="w-full outline-none bg-blue-600 text-white rounded-lg px-5 py-2 hover:bg-blue-700 transition" onClick={handleSubmit}>
                Signup
              </button>
            </div>
            <p>
              Already have a account{" "}
              <a href="" className="text-blue-700" onClick={()=>{
                navigate("/Signinpage");
              }}>
                login here
              </a>
